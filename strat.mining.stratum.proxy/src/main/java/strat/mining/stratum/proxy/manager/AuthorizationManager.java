...
public class AuthorizationManager {
	 ...
	 */
	public void unbanUser(String username) throws NotFoundException {
		if (!bannedUserNames.remove(username)) {
			throw new NotFoundException("User " + username + " not banned. Cannot unban.");
		}
	}
	 ...
	 */
	public void banAddress(String address) throws UnknownHostException {
	 ...
	 * @throws UnknownHostException
	 */
	public void unbanAddress(String address) throws UnknownHostException, NotFoundException {
		InetAddress inetAddress = InetAddress.getByName(address);
