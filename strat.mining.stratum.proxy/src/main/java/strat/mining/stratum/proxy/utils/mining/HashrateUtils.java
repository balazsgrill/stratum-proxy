...
public final class HashrateUtils {
	 ...
	 * @return
	 */
	public static double getHashrateFromShareList(Deque<Share> shareList, int samplingHashesPeriod, CryptoAlgorithm algo) {
		...
		double averageNumberOfHashesPerShareAtDifficultyOne = 0;
